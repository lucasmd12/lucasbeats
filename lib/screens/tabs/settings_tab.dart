...
import '../../models/role_model.dart'; // Adicionado import para Role
import '../call_history_page.dart';
import '../profile_screen.dart';
import '../privacy_screen.dart';
import '../notification_settings_screen.dart';
import '../about_page.dart';
import '../../screens/clan_custon_roles_screen.dart'; // Importar ClanCustomRolesScreen
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Seção VoIP // Seção Gerenciamento de Clã
          _buildSection(
            context,
            'VoIP',
            [
          ...
          // Seção Gerenciamento de Clã
          Consumer<AuthService>(
            builder: (context, authService, child) {
              final currentUser = authService.currentUser;
              // Verificar se o usuário logado é ADM ou Líder de Clã
              final canManageRoles = currentUser?.role == Role.adm || currentUser?.clanRole == Role.clanLeader;

              if (!canManageRoles) {
                return const SizedBox.shrink(); // Não mostra a seção se não tiver permissão
              }
              ...
              return _buildSection(
                ...
                [
                  _buildSettingItem(
                    ...
                    title: 'Gerenciar Cargos Customizados',
                    subtitle: 'Adicionar, editar ou remover cargos',
                    onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => ClanCustomRolesScreen(clanId: clanId)),
 );},
                  ),
                ],
              );
