...
class _QRRCreateScreenState extends State<QRRCreateScreen> {
  ...
  final _requiredRolesController = TextEditingController();
    ...
    try {
      ...
      final Map<String, dynamic> newQRR = {
        ...
        'requiredRoles': _requiredRolesController.text.isEmpty
            ? []
            : _requiredRolesController.text.split(',').map((e) => e.trim()).where((e) => e.isNotEmpty).toList(),
      };
                ...
                child: Column(
                  children: [
                    ...
                    _buildTextField(
                      ...
                      label: 'Roles Necessários (separados por vírgula)',
                      hint: 'Ex: LÍDER, MEMBRO',
                    ),
