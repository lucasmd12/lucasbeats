...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      // Fazer apenas o registro - o AuthService já faz login automático internamente
      ...
      if (success) {
        ...
        if (mounted) {
          ...
          // Não precisa navegar manualmente - o Consumer<AuthProvider> no main.dart vai detectar
          // a mudança de estado e navegar automaticamente para HomeScreen
        }
      } else {
        // Registration failed
        if (mounted) {
