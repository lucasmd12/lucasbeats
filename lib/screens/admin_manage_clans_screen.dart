            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  } else if (isAdmMaster && !_isDesignatedFederationLeader) {
                    // If ADM_MASTER and not designated leader, and selected null, explicitly pass null
                    clanData['federationId'] = null;
                  } else if (!isAdmMaster && !_isDesignatedFederationLeader && widget.federationId == null) {
                     // If not ADM_MASTER, not designated leader, and no federationId provided, clan must not be created without federation.
                     _showSnackBar('Error: Only ADM_MASTERs or designated Federation Leaders can create unassigned clans.', isError: true);
                     return;
                  }
